...
export const jumpGame: Problem = {
    ...
    You are given an integer array <code style="color: black;">nums</code>. You are initially positioned at the <strong>first index</strong>
    and each element in the array represents your maximum jump length at that position.
  </p>
    <p class='mt-3'>
    Return <code style="color: black;">true</code> if you can reach the last index, or <code style="color: black;">false</code> otherwise.
    </p>
  `,
	examples: [
		{
